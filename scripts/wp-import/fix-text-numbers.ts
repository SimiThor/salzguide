...
// Sprachen. Nur Deutsch zu ändern hiesse, den Widerspruch in acht Sprachen stehen zu lassen
...
/**
 * Dieselbe Zahl in allen Schreibweisen, die in den neun Sprachen vorkommen, jeweils mit
