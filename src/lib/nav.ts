...
//
// - Reihenfolge = die PC-Lesereihenfolge: erst die Leisten-Punkte (primary, von links nach
//   rechts), dann die "Mehr"-Punkte (von oben nach unten). Der iPhone-Burger listet alle
//   stur in dieser Reihenfolge untereinander - so sehen PC und iPhone dieselbe Ordnung,
//   ohne dass eine Stelle umsortieren muss.
